	...
	<div class="container">
		<!-- INICIO DIV NUEVO -->
						...
						<div class="modal-header" style="padding: 5px 20px">
							<h4 id="idMensaje">Registro de Televisores</h4>
						</div>
						<div class="modal-body" style="padding: 20px 10px;">
							<form id="id_registra" accept-charset="UTF-8" action="saveTelevisor" 
				                            ...
				                            <div class="panel-heading" style="text-align: center;font-size: 14px">
				                                ...
				                                <div class="panel-body">
				                                    <div class="form-group">
				                                        ...
				                                        <div class="col-lg-5">
															<input class="form-control"  name="televisor.nombre" placeholder="Ingrese el Nombre"/>
				                                        </div>
				                                    </div>
				                                    <div class="form-group">
				                                        <label class="col-lg-3 control-label" for="id_reg_sueldo">Precio</label>
				                                        <div class="col-lg-5">
															<input class="form-control" name="televisor.precio" placeholder="Ingrese Precio"/>
				                                        </div>
				                                    </div>
				                                    <div class="form-group">
				                                        <label class="col-lg-3 control-label" for="id_reg_nombre">Stock</label>
				                                        <div class="col-lg-5">
															<input class="form-control" name="televisor.stock" placeholder="Ingrese Stock"/>
				                                        </div>
				                                    </div>
				                                     <div class="form-group">
				                                        <label class="col-lg-3 control-label" for="id_reg_nombre">Fecha</label>
				                                        <div class="col-lg-5">
															<input class="form-control" name="televisor.fecha" placeholder="Ingrese Fecha"/>
				                                        </div>
				                                    </div>					                                   		                                    
